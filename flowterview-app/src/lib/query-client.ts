...
export const queryKeys = {
  ...
  interviews: {
    ...
    list: (filters: Record<string, any>) => [...queryKeys.interviews.lists(), filters] as const,
    detail: (id: string) => [...queryKeys.interviews.all(), 'detail', id] as const,
    byJob: (jobId: string) => [...queryKeys.interviews.all(), 'by-job', jobId] as const,
  },
  ...
  analytics: {
    ...
    orgAverageScore: () => [...queryKeys.analytics.all(), 'org-average-score'] as const,
    interview: (interviewId: string) => [...queryKeys.analytics.all(), 'interview', interviewId] as const,
    candidate: (candidateId: string) => [...queryKeys.analytics.all(), 'candidate', candidateId] as const,
  },
} as const;

// Helper function to invalidate related queries
export const invalidateRelatedQueries = async (queryClient: QueryClient, action: string, entityType: string) => {
  switch (entityType) {
    case 'candidates':
      ...
      await queryClient.invalidateQueries({ queryKey: queryKeys.interviews.all() });
